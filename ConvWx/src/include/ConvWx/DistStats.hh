...
public:
   ...
   /**
    *  @return Number of histograms averaged and represented in  pObsHistTotals
    */ 
   inline int getNObsHists(void) const {return pNObsHists;}

   /**
    *  @return Number of histograms averaged and represented in  pFcstHistTotals
    */ 
...
private:
   ...
   /**
    * Container to hold observation histograms
    */
   std::vector < int > pObsHistTotals;
   
   /**
    * Container to hold forecast histograms
    */
